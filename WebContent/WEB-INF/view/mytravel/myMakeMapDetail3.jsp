...
<jsp:include page="/WEB-INF/view/include/header.jsp" />
 ...
 <section class="section section-lg bg-white" style="background: linear-gradient(-32deg, #8b0fe4 -2%, rgb(41, 41, 58) 26%); padding-bottom: 0px; padding-top: 0px; height:250px;">
        <!-- section wave-->
           <h4 style="color:white; padding-top: 192px;margin-left: 50px; padding-right: 880px;"> 나의 여행 계획 상세보기 </h4>
		...
		<section class="section section-lg bg-white text-center">
			<div class="tabs-custom tabs-horizontal tabs-buttons">
				<ul id="tabs" class="nav nav-tabs" data-tabs="tabs" style="border-bottom: solid;border-bottom-color: grey;">
...
<c:forEach begin="1" varStatus="status" end="${traveldaynum}">
	...
	<%-- 						<div class=bak > <h1> <%=sleepday %>박 <%= sleepday+1 %>일</h1> </div> --%>
						...
						<div class="row" style="margin-top: 37px;padding-left: 30px;">
							<!-- 구글맵 시작 -->
							<div class="col-md-7" style="margin-top: 10px;">
								<div id="map-area${status.index}" style="width: 100%; height: 800px;">
									<div id="map-canvas${status.index}" style="width: 100%; height: 800px;"></div>
								</div>
							</div>	
							<!-- 구글맵end -->
								...
								<div class="row">
										...
										<div class="flickr-item" data-type="flickr-item"
											...
											<div class="thumb-default">
												<a class="flickr-link" href="#" data-image_b="href"
													...
													src="https://unsplash.it/400/300/?random" data-image_b="src"
													data-title="alt" alt="">
									...
									<div class="form-wrap form-wrap-validation"
										...
										<div class="row" style="margin-right: 0px;">
											<div class="col-sm-4">
												<p style="margin-bottom: 10px;">
													<span style="font-size: 20; font-weight: 30; color: red;">일정입력</span>
												</p>
											</div>
										...
										<textarea class="form-input" id="form-1-message" name="message"
											style="min-width: 95%; min-height: 140px;"></textarea>
									</div>
								</div>
								<!-- 알람 -->
								<div class="row">
							...
							<!-- 일정sample2 -->
							<div class="box-classic box-shadow box-novi"
								style="margin-left: 0px; margin-right: 0px; margin-top: 10px; padding-left: 12px; 
	...
	<section class="section section-lg bg-white text-center">
					<div class="row">
						<div class="col-md-3"></div>
						<div class="col-md-2">
							<input type="button" style="min-width: 180px;"
